...
while route_diff > 10:
        ...
        for _ in range(num_iterations):
            for aircraft in aircraft_list:
                if aircraft.active:
                    ...
                    neighbour_weights = [1 for i in range(len(list(G.neighbors(aircraft.current_node))))]
    ...
    num_routes.append(visited_route_count)
    print(num_routes)
    # print(i)
    route_diff = num_routes[counter] - num_routes[counter-1]
    print(route_diff)
    counter += 1
